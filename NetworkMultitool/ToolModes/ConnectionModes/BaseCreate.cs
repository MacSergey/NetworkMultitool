...
namespace NetworkMultitool
{
    public abstract class BaseCreateMode : BaseNetworkMultitoolMode
    {
        ...
        public BaseCreateMode()
        {
            ...
            Plus = GetShortcut(KeyCode.Equals, PressPlus, ToolModeType.Create, repeat: true, ignoreModifiers: true);
            Minus = GetShortcut(KeyCode.Minus, PressMinus, ToolModeType.Create, repeat: true, ignoreModifiers: true);
            NumPadPlus = GetShortcut(KeyCode.KeypadPlus, PressPlus, ToolModeType.Create, repeat: true, ignoreModifiers: true);
            NumPadMinus = GetShortcut(KeyCode.KeypadMinus, PressMinus, ToolModeType.Create, repeat: true, ignoreModifiers: true);
        }
